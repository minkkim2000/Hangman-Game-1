...
// Number of guesses remaining
  ...
  this.numberOfGuessesCount = this.numberOfGuessesCount--;
}
...
this.insertArtistIntoDom = function () {
  ...
  this.hideArtistNameInDom(artistUl);
}

// Hide words in DOM
  this.hideArtistNameInDom = function (artistUl) {
